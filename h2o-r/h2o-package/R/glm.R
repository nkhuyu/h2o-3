...
#'        columns. Must be one of: "AUTO", "IRLSM", "IRLSM_SPEEDUP", "IRLSM_SPEEDUP2", "L_BFGS",
...
h2o.glm <- function(x, y, training_frame,
                    ...
                    theta = 1e-10,
                    solver = c("AUTO", "IRLSM", "IRLSM_SPEEDUP", "IRLSM_SPEEDUP2", "L_BFGS", "COORDINATE_DESCENT_NAIVE", "COORDINATE_DESCENT", "GRADIENT_DESCENT_LH", "GRADIENT_DESCENT_SQERR"),
                    alpha = NULL,
                    lambda = NULL,
                    lambda_search = FALSE,
                    early_stopping = TRUE,
