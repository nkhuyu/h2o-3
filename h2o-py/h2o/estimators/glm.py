...
class H2OGeneralizedLinearEstimator(H2OEstimator):
    ...
    def solver(self):
        ...
        One of: ``"auto"``, ``"irlsm"``, ``"irlsm_speedup"``, ``"irlsm_speedup2"``, ``"l_bfgs"``,
        ``"coordinate_descent_naive"``, ``"coordinate_descent"``, ``"gradient_descent_lh"``,
    ...
    def solver(self, solver):
        assert_is_type(solver, None, Enum("auto", "irlsm", "irlsm_speedup", "irlsm_speedup2", "l_bfgs", "coordinate_descent_naive", "coordinate_descent", "gradient_descent_lh", "gradient_descent_sqerr"))
